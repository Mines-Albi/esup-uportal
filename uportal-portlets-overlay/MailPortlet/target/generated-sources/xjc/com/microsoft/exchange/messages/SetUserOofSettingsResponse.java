...
@XmlRootElement(name = "SetUserOofSettingsResponse")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SetUserOofSettingsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SetUserOofSettingsResponse that = ((SetUserOofSettingsResponse) object);
        {
