    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EmailAddressDictionaryEntryType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EmailAddressDictionaryEntryType that = ((EmailAddressDictionaryEntryType) object);
        {
            String lhsValue;
        ...
        {
            EmailAddressKeyType lhsKey;
            lhsKey = this.getKey();
            EmailAddressKeyType rhsKey;
            rhsKey = that.getKey();
