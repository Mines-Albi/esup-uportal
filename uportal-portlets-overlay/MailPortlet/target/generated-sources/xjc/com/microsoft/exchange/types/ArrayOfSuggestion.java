    ...
    implements Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Suggestion> theSuggestions;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ArrayOfSuggestion)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ArrayOfSuggestion that = ((ArrayOfSuggestion) object);
        {
            List<Suggestion> lhsSuggestions;
            lhsSuggestions = this.getSuggestions();
            List<Suggestion> rhsSuggestions;
