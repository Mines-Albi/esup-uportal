...
public class SyncFolderItemsCreateOrUpdateType implements Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            DistributionListType theDistributionList;
            theDistributionList = this.getDistributionList();
            strategy.appendField(locator, this, "distributionList", buffer, theDistributionList);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SyncFolderItemsCreateOrUpdateType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SyncFolderItemsCreateOrUpdateType that = ((SyncFolderItemsCreateOrUpdateType) object);
        {
        ...
        {
            DistributionListType lhsDistributionList;
            lhsDistributionList = this.getDistributionList();
            DistributionListType rhsDistributionList;
            rhsDistributionList = that.getDistributionList();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "distributionList", lhsDistributionList), LocatorUtils.property(thatLocator, "distributionList", rhsDistributionList), lhsDistributionList, rhsDistributionList)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            DistributionListType theDistributionList;
            theDistributionList = this.getDistributionList();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "distributionList", theDistributionList), currentHashCode, theDistributionList);
        }
        {
            ContactItemType theContact;
            theContact = this.getContact();
