    ...
    implements Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            UnindexedFieldURIType theFieldURI;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PathToUnindexedFieldType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final PathToUnindexedFieldType that = ((PathToUnindexedFieldType) object);
        {
            UnindexedFieldURIType lhsFieldURI;
            lhsFieldURI = this.getFieldURI();
            UnindexedFieldURIType rhsFieldURI;
