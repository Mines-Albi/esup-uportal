    ...
    implements Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            ArrayOfGroupedItemsType theGroups;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FindItemParentType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FindItemParentType that = ((FindItemParentType) object);
        {
            ArrayOfGroupedItemsType lhsGroups;
            lhsGroups = this.getGroups();
            ArrayOfGroupedItemsType rhsGroups;
