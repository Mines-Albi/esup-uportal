    ...
    implements Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<ResolutionType> theResolutions;
            theResolutions = this.getResolutions();
            strategy.appendField(locator, this, "resolutions", buffer, theResolutions);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ArrayOfResolutionType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ArrayOfResolutionType that = ((ArrayOfResolutionType) object);
        {
            List<ResolutionType> lhsResolutions;
            lhsResolutions = this.getResolutions();
            List<ResolutionType> rhsResolutions;
            rhsResolutions = that.getResolutions();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "resolutions", lhsResolutions), LocatorUtils.property(thatLocator, "resolutions", rhsResolutions), lhsResolutions, rhsResolutions)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<ResolutionType> theResolutions;
            theResolutions = this.getResolutions();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "resolutions", theResolutions), currentHashCode, theResolutions);
        }
        {
            Integer theIndexedPagingOffset;
            theIndexedPagingOffset = this.getIndexedPagingOffset();
