    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<ImAddressDictionaryEntryType> entries;
     ...
     * 
     */
    public List<ImAddressDictionaryEntryType> getEntries() {
        if (entries == null) {
            entries = new ArrayList<ImAddressDictionaryEntryType>();
        }
        return this.entries;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<ImAddressDictionaryEntryType> theEntries;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ImAddressDictionaryType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ImAddressDictionaryType that = ((ImAddressDictionaryType) object);
        {
            List<ImAddressDictionaryEntryType> lhsEntries;
            lhsEntries = this.getEntries();
            List<ImAddressDictionaryEntryType> rhsEntries;
