...
@XmlSeeAlso({
    AlternateMailboxCollectionSetting.class,
    StringSetting.class,
    WebClientUrlCollectionSetting.class,
    ProtocolConnectionCollectionSetting.class
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final UserSetting that = ((UserSetting) object);
        {
            String lhsName;
