    ...
    implements Equals, HashCode, ToString
{
    ...
    protected List<UserIdType> userIds;
     ...
     * 
     */
    public List<UserIdType> getUserIds() {
        if (userIds == null) {
            userIds = new ArrayList<UserIdType>();
        }
        return this.userIds;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ArrayOfUserIdType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ArrayOfUserIdType that = ((ArrayOfUserIdType) object);
        {
            List<UserIdType> lhsUserIds;
            lhsUserIds = this.getUserIds();
            List<UserIdType> rhsUserIds;
