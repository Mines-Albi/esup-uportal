...
public class SyncFolderItemsReadFlagType implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SyncFolderItemsReadFlagType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SyncFolderItemsReadFlagType that = ((SyncFolderItemsReadFlagType) object);
        {
